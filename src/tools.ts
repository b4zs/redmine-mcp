...
export function registerAllTools(server: FastMCP, client: RedmineClient) {
  server.addTool({
    ...
    parameters: z.strictObject({
      ...
      sort: z.string().optional().describe('Redmine sort string, e.g. "updated_on:desc,priority:desc".'),
